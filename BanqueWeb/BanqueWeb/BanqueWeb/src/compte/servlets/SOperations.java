...
public class SOperations extends HttpServlet {
	 ...
	 * @return <b>true</b> si noCompte est bien un nombre numérique, <b>false</b> sinon
	 */
	...
	/**
	 * Vérifie que <i>noCompte</i> est de la bonne longueur.
	 * @param noCompte String numéro de compte
	 * @return <b>true</b> si la taille de noCompte est de 4 caractères, <b>false</b> sinon
	 */
	private boolean verifNoDeCompteLength(String noCompte) {
